...
3. **Mechanism** When relevent explicitly state the order and timing of the mechanisms: (e.g.,Myogenic Mechanism: Instantaneous (fastest, intrinsic), Tubuloglomerular Feedback (TGF): Slower (seconds to minutes), RAAS: Slowest (minutes to hours, hormonal)).
